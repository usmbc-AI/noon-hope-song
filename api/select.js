...
[선곡 이유(reason) — 매우 중요]
- 각 곡의 reason은 반드시 **"오늘의 날씨/계절"과 "그 곡의 장르·아티스트 스타일 태그, 그리고 당신이 아는 그 곡의 실제 분위기"를 연결**해 왜 지금 어울리는지 분명히 설명하세요. (절기는 위 오프닝에서만 다루고, 곡 이유엔 넣지 마세요.)
...
- opening_ment는 오늘의 기온·하늘·바람을 언급하는 3~4문장의 정겨운 오프닝 멘트로. ${ctx.term ? "오늘은 절기 당일이니 절기도 기념하듯 한 번 언급하세요." : "절기(소서·처서 등)는 언급하지 마세요 — 오늘은 절기 당일이 아닙니다."}
