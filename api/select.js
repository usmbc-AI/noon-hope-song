...
[방송용 멘트(dj_line) — 음성으로 읽을 대사]
- 각 곡마다 **dj_line**도 써주세요. 이건 라디오 DJ가 **입으로 소개하는** 짧은 대사예요(귀로 듣기 좋은 구어체).
- reason(분석적 설명)과 달리, dj_line은 **자연스러운 말투 1~2문장**으로: 곡 제목·가수를 자연스럽게 언급하며 정겹게 소개. (예: "다음 곡은 아이유의 '밤편지'예요. 이런 날 듣기 딱 좋죠, 편안하게 들어보세요~")
- 이모지·괄호·해시태그·특수기호는 넣지 마세요(그대로 소리내어 읽힙니다).
