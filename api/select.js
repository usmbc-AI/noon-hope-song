...
- 같은 키워드를 이번엔 **가볍고 유머러스하게**! 드립·말장난·능청·과장 대환영.
- reason은 **짧고 유쾌하게 1~2문장** (피식 웃기거나 빵 터지게). 진지 금지.
  (예시 톤 — '무더위,트럼프,냉면': "무더위엔 짜증, 트럼프 뉴스엔 두통, 근데 냉면 한 그릇이면 다 용서되잖아요? 그냥 신나게 한 곡 때리고 시원하게 넘어갑시다 🍜")
